...
export default function Home() {
  ...
  return <main className="app-shell">
    ...
    {builder && <BuilderDialog catalogue={catalogue} setlist={builder} saveState={setlistSaveState} onRetry={() => void flushSetlistSaves()} onClose={() => setBuilderId(null)} onPatch={patchBuilder} onPublish={() => { patchBuilder({ state: "published" }); setBuilderId(null); flash("Setlist veröffentlicht – jetzt darf bewertet werden"); }} />}
...
function BuilderDialog({ catalogue, setlist, saveState, onRetry, onClose, onPatch, onPublish }: { catalogue: Piece[]; setlist: Setlist; saveState: SetlistSaveState; onRetry: () => void; onClose: () => void; onPatch: (patch: Partial<Setlist>) => void; onPublish: () => void }) {
